...
SET(RTEMS_BSP_PREFIX "$ENV{HOME}/development3/rtems-${CMAKE_SYSTEM_VERSION}/rpi" CACHE PATH 
    "RTEMS BSP install directory")

# The BSP that will be used for this build
set(RTEMS_BSP "raspberrypi")
...
set(RTEMS_BSP_C_FLAGS           "-mcpu=arm1176jzf-s -fno-common")
...
SET(CFE_SYSTEM_PSPNAME                  rpi-rtems)
SET(OSAL_SYSTEM_BSPTYPE                 arm-rtems)
